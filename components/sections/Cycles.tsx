...
const dailyItems = [
  {
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 stroke-[#718472]" fill="none" strokeWidth={1.8} aria-hidden="true">
...
export default function Cycles() {
  return (
    <section style={{ background: "#f2f2f2" }} className="py-24 md:py-32">
      <div className="mx-auto max-w-[1000px] px-5 md:px-10">
        ...
        <RevealWrapper delay={0}>
          <div className="mb-24 text-center">
            ...
            <p
              className="mx-auto max-w-[540px] font-light leading-[1.75] text-[rgba(17,17,17,0.62)]"
              style={{ fontSize: "18px" }}
            >
          ...
          {cycles.map((c, i) => (
            <RevealWrapper key={c.num} delay={80 + i * 80}>
              ...
              >
                ...
                <div className="mb-2 text-[22px] font-extrabold text-[#111111]">
                  {c.name}
                </div>
                <div className="mb-2 text-sm font-bold leading-[1.4] text-[#111111]">
                  {c.lead}
                </div>
                <div className="text-sm font-light leading-[1.65] text-[rgba(17,17,17,0.62)]">
                  {c.desc}
                </div>
              </div>
            </RevealWrapper>
        ...
        <RevealWrapper delay={0}>
          <div className="mb-8 text-center">
            <div
              className="text-[11px] font-bold tracking-[0.18em] text-[#718472]"
              style={{
                fontFamily: "var(--font-montserrat)",
                textTransform: "uppercase",
              }}
          ...
          {dailyItems.map((item, i) => (
            <RevealWrapper key={item.title} delay={80 + (i % 4) * 80}>
              <div className="flex items-start gap-6 rounded-[20px] bg-white p-6 shadow-[0_2px_10px_rgba(0,0,0,0.07)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[8px_8px_24px_rgba(0,0,0,0.12)]">
                ...
                <div>
                  <div className="mb-1 text-[15px] font-bold text-[#111111]">
                    {item.title}
                  </div>
                  <div className="text-[13px] font-light leading-[1.6] text-[rgba(17,17,17,0.62)]">
                    {item.desc}
                  </div>
                </div>
              </div>
